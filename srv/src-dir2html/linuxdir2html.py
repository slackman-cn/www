...
def main():
    ...
    generateHTML(
        ...
        total_numFiles, total_numDirs, grand_total_size, file_links, pathToIndex
        )
    return
...
def generateHTML(
    ...
    app_link, numFiles, numDirs, grand_total_size, file_links,pathToIndex
    ):
    ...
    for line in template_file:
        ...
        if '[DIR DATA]' in modified_line:
            ...
            for line in dir_results:
                ...
                sane_format = sane_format.replace(str(pathToIndex) , './')
        ...
        modified_line = modified_line.replace('[TITLE]', 'TongWeb v7 doc')
